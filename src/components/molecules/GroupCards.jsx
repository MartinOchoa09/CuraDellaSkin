                ...
                <div class="p-4">
                    <div class="d-flex">
                        ...
                        <div className="corazon-card">
                            <button onClick={agregarFavorito} className="boton-img-svg">
                                <svg
                                    xmlns={HeartImg}
                                    viewBox="0 0 24 24"
                                    fill={heartColor}
                    ...
                    <button class="btn btn-light fs-5 py-2 px-4 boton-comprar" type="button" onClick={handlerClickComprar}>Comprar</button>
